...
def main():
    ...
    path = r"config/ccnet_unet_30k_100%_224x224_ACDC.yaml"
    ...
    args.ema_model_save_path = os.path.join(
        args.save_path, "model", "ema_model_model.pth")
    ...
    # step 2: 训练模型
    CCNet(model, ema_model, train_loader, test_loader, args)
