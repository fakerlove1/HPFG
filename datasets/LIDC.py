...
class LIDC(Dataset):
    ...
    def load_annotations(self):
        ...
        self.img_dir = [
            self.root + "/image_r/{}.png".format(item) for item in self.sample_list]
        self.ann_dir = [self.root + "/mask_r/LIDC_Mask_{}.png".format(
...
def get_ssl_lidc_loader(root=r'/home/ubuntu/data/LIDC/LIDC-DIC',
                        batch_size=8,
