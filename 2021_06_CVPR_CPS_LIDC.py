...
def main():
    ...
    path = r"config/cps_unet_30k_96x96_LIDC.yaml"
    ...
    for epoch in range(max_epoch):
        ...
        for i, (unlabel_img, _) in enumerate(tqdm(unlabel_loader)):
            ...
            if cur_itrs % args.step_size == 0:
                mean_dice, mean_hd952 = test_lidc(model=model1, test_loader=test_loader, args=args, cur_itrs=cur_itrs, name="model1")
                ...
                mean_dice, mean_hd952 = test_lidc(model=model2, test_loader=test_loader, args=args, cur_itrs=cur_itrs, name="model2")
